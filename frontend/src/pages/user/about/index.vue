  ...
  <view class="container">
    ...
    <view class="card">
      ...
      <text class="desc">
        ...
        【重要提醒】：本程序内置的高危警告及目标范围（基于 T/CVMA 195-2024 等相关参考）仅供监控参考，<text style="font-weight: 800; color: #E74C3C;">绝不能替代执业兽医师的专业诊断与治疗建议</text>。
        
        如果您的猫咪出现异常症状（如多饮多尿、食欲减退、呕吐或极度虚弱），请立即联系并前往专业的宠物医院就诊！
      </text>
    </view>
